...
\item Vi vil udvikle nogle moduler  der er uafhængige af hinanden, således at vores grafik i mindst mulig grad kommunikerer med vores modul indeholdende spillets regler(Refball.c). Denne kommunikation skal foregå igennem main-metoden, således man let kan få et overblik ved at se på main-metoden.
